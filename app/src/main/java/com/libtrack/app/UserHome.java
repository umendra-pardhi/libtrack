...
public class UserHome extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBook1=(CardView)findViewById(R.id.searchBook1);
        seeBook=(CardView) findViewById(R.id.seeBook);
        logOut1=(CardView) findViewById(R.id.logOut1);
        buttonReissue=(CardView) findViewById(R.id.buttonReissue);
    ...
    private CardView searchBook1;
    private CardView seeBook;
    private CardView logOut1;
    private CardView buttonReissue;
